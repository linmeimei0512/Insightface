...
# ms1m refine v1
# ==============================
elif config.dataset == "ms1m-refine-v1":
    config.rec = "../../../../Dataset/faces_ms1m-refine-v1_112X112/faces_ms1m_112X112"
...
# ==============================
    ...
    config.rec = "../../../../Dataset/ms1m-retinaface-t1"
    config.num_classes = 91180
    config.num_epoch = 25
    config.warmup_epoch = -1
    config.val_targets = ["lfw", "cfp_fp", "agedb_30"]
...
# ==============================
    ...
    config.rec = "../../../../Deep_Learning/InsightFace/Python/Dataset/faces_webface_112x112"
