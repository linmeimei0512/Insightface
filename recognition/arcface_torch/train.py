...
# file = '../../../../Deep_Learning/InsightFace/Python/Dataset/faces_webface_112x112'
...
def main(args):
    ...
    if args.resume:
        try:
            backbone_pth = os.path.join(cfg.output, "weight_backbone.pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--network', type=str, default='iresnet50', help='backbone network (iresnet18, iresnet34, iresnet50, iresnet100, iresnet200)')
    parser.add_argument('--loss', type=str, default='ArcFace', help='loss function (Cosface, Arcface)')
